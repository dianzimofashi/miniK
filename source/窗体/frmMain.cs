...
using GIS应用系统.窗体;
using GIS应用系统.数据库;
using GIS应用系统.数据库.DBFrm;
using GIS应用系统.KDE核密度计算;
...
namespace GIS应用系统
{
    public partial class frmMain : Form
    {
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            if (aoInit.Initialize(esriLicenseProductCode.esriLicenseProductCodeEngine) != esriLicenseStatus.esriLicenseCheckedOut)
            {
                MessageBox.Show("ArcGIS Engine 授权失败");
                return;
            }

            if (aoInit.CheckOutExtension(esriLicenseExtensionCode.esriLicenseExtensionCodeSpatialAnalyst) != esriLicenseStatus.esriLicenseCheckedOut)
            {
                MessageBox.Show("Spatial Analyst 扩展授权失败");
                return;
            }
            //---
        ...
        {
            frmAboutCreator aboutCreator = new frmAboutCreator();
            aboutCreator.Show();
        }
        ...
        private void kDE核密度KToolStripMenuItem_Click(object sender, EventArgs e)
        {

        }

        private void 快捷栏ToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void 直接导出至ToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void kDEToolStripMenuItem_Click(object sender, EventArgs e)//精简KDE小菜单按钮,->,kDE
        {
            frmKDE kdeForm = new frmKDE(axMapControl1);  // 传入主窗体中的 MapControl
            kdeForm.ShowDialog();
        }
        ...
        private void 导入数据至地图ToolStripMenuItem_Click(object sender, EventArgs e)
        {

        }

        private void 导出图层至数据库ToolStripMenuItem_Click(object sender, EventArgs e)
        {

        }

        private void arcSDE连接ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmArcSDEConn frmArcSDEConn = new frmArcSDEConn();
            frmArcSDEConn.Show();//展示“数据库(D)”中三级菜单窗体“连接ArcSDE”


        }
        private void arcSDE存储ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmArcSDEStoring frnArcSDEStoring = new frmArcSDEStoring();
            frnArcSDEStoring.Show();
